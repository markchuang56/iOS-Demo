...
@interface CableInfoViewController ()
{
    NSMutableArray *cbInfo;
}
@end

@implementation CableInfoViewController
...
- (id)init:(NSMutableArray *)info
{
    ...
    if (self) {
        ...
        cbInfo = [[NSMutableArray alloc]init];
        [cbInfo addObjectsFromArray:info];
        ...
        UIBarButtonItem *btnBack = [[UIBarButtonItem alloc]
                                    ...
                                    target:self action:@selector(cbInfoBack:)];
        UINavigationItem *navItem = [[UINavigationItem alloc]
                                     initWithTitle:@"CABLE INFO"];
...
//    return [cbInfo count];
    ...
    return [LibDelegateFunc sharedInstance].indexStatus;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    rowString = @"CABLE INFO TEST";
    
    NSString *st = [NSString stringWithFormat:@"%02X", [LibDelegateFunc sharedInstance].byteStatus[row]];
...
+ (CableInfoViewController *)sharedInstance
{
    ...
    NSLog(@"EM - CABLE INFO the instance value @%@", _sharedObject);
